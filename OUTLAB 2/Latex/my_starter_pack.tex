...
\centering
\includegraphics[height=\textwidth]{aristotle}
\caption{Aristotle: The first former logocian}
\label{fig2}
\end{subfigure}
\begin{subfigure}[b]{0.4\textwidth}
\centering
\includegraphics[height=\textwidth]{kripke}
\caption{Saul Kripke: we've come a long way since then.}
\end{subfigure}
\end{figure}
...
\hline
\multirow{2}{*}{$\mathcal{O}(n\log(n))$} & Merge Sort\\
& Fast Fourier Transform\\
\hline
\multirow{2}{*}{$\mathcal{O}(n^2)$} & Bubble Sort\\
